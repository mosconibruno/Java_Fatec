...
public class servletFigura extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Triangulo objTriangulo = new Triangulo(base, altura);
                        
            RequestDispatcher rd = request.getRequestDispatcher("exibeResultado.jsp");
            request.setAttribute("areaRet", objRetangulo.calcularArea());
            request.setAttribute("perimetroRet", objRetangulo.calcularPerimetro());
            request.setAttribute("areaTri", objTriangulo.calcularArea());
            request.setAttribute("perimetroTri", objTriangulo.calcularPerimetro());
